...
v1.0 · R01/R02/R06/R07 · 실제 공급자 parser 승인: PENDING SAMPLE
...
| Coupang Partners | 기존 운영 문서에 과거 제휴 링크 생성 기록. 현재 공개 포털은 JavaScript 실행 필요 | 현재 자격·도메인 등록·API 권한·실적 export 실제 컬럼 | 국내 기존 자산 연동 후보 |
